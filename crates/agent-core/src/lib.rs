...
pub use facade::{
    AgentStatusInfo, AppFacade, PermissionDecision, SendMessageRequest, SessionMeta,
    StartSessionRequest, TaskGraphSnapshot, TaskSnapshot, TraceEntry, WorkspaceInfo,
};
