...
| agent-models  | LLM adapters, model metadata/context windows, retry resilience, server-side tools                                                                                                                        | `ModelClient`, `ModelRouter`, `ModelRegistry`, `RetryConfig`, `ServerTool`                                       |
