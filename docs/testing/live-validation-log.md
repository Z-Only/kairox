...
CARGO_HOME=~/.cargo RUSTUP_HOME=~/.rustup
CARGO_TARGET_DIR=~/AIProjects/kairox/target KAIROX_DEV_PORT=1442
...
CARGO_HOME=~/.cargo RUSTUP_HOME=~/.rustup
CARGO_TARGET_DIR=~/AIProjects/kairox/target KAIROX_DEV_PORT=1440
KAIROX_DEV_STRICT_PORT=1 bun run tauri -- dev --features pilot`. The temp
...
CARGO_HOME=~/.cargo RUSTUP_HOME=~/.rustup
CARGO_TARGET_DIR=~/AIProjects/kairox/target KAIROX_DEV_PORT=<port>
KAIROX_DEV_STRICT_PORT=1 bun run tauri -- dev --features pilot`. The temp
  profile used `api_key_env = "KAIROX_VALIDATION_ALI_MO_KEY"` with the value
...
- Evidence: A printed pilot socket
  ...
  `workspace_root=~/AIProjects/kairox/.worktrees/docs-live-instance-registry-0605/apps/agent-gui/src-tauri`,
  and `executable=~/AIProjects/kairox/target/debug/agent-gui-tauri`.
