...
| **agent-tools**   | Tool registry, orthogonal Approval × Sandbox policy engine, built-in tools (`shell.exec`, `fs.read`, `fs.write`, `fs.list`, `patch.apply`, `search.ripgrep`, `monitor.start/list/stop`), MonitorRegistry for background process lifecycle | `ToolRegistry`, `PolicyEngine`, `ApprovalPolicy`, `SandboxPolicy`, `PolicyDecision`, `PolicyRisk`, `PermissionEngine` (thin wrapper), `Tool` trait, `ToolRisk`, `McpToolAdapter`, `MonitorRegistry`, `MonitorMetadata`                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
