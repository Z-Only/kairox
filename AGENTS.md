...
| **agent-eval**    | Headless evaluation harness (binary `kairox-eval`) for replaying fixture profiles against the agent loop                                                                                                                  | `kairox-eval` binary, `EvalCase`, `EvalRunner`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
│   ├── agent-mcp/          # MCP client, transports (stdio, sse), lifecycle, health checks,
