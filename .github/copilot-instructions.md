...
Kairox is a local-first AI agent workbench: Rust workspace core + Tauri/Vue GUI + ratatui TUI. It includes a native skills system, GUI-managed user/project instructions, and per-project `.kairox/` config discovery.
