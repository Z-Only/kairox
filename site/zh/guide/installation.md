...
这会基于本地 `main` 创建 `.worktrees/feat-my-feature/`,并配置好 Husky。如果需要最新 upstream base,请先同步本地 `main`。原 checkout 保持干净,方便做 rebase 和紧急修复。贡献流程详见 [Contributing](../community/contributing)。
